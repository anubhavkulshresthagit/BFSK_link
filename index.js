...
free2.oninput = function(){
  output3.innerHTML = free2.value;
  var arr1 = [0,-82,-65,-47,-36,-28,-15,-5,5,18,32,40,52,60,70,80];
  
  var rot3 = document.getElementById("pin3");
  var z2 = arr1[this.value];

  rot3.style.transform = "rotate("+ z2 + "deg)";
}
...
var counter2 =0;
var amp1 = amp.value;
var frepre = fre.value;
var fre2 = free2.value;
var freorg = 0.1;
// var arr = [1,0,1,1,0,1,1,1];
var runner = arr.length;
var len =0;
var flag =0;
//var fre =2.5; // real frequency is 2000  if i want fre/100 and put
...
var increase = (Math.PI * 2 / 100)*frepre;
...
/////////////////////////////////////////////////////   blank Graph     /////////////////////////////////
 ...
 updateChart(dataLength); 
      ...
      alert("FISRT GENERATE a BFSK SIGNAL")
    }
  }
